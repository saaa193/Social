...
public class ReseauDashboard extends JPanel {
	...
	public boolean afficherFamille() {
		return btnFamille.isSelected();
	}

	public boolean afficherTravail() {
		return btnTravail.isSelected();
	}

	public boolean afficherAmis() {
		return btnAmis.isSelected();
	}
}