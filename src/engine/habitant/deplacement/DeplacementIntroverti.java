...
/**
 * Déplacement introverti : l'habitant bouge peu et reste dans sa zone.
 * L'introverti n'a pas besoin de chercher les autres pour se sentir bien.
 * Lié au trait OCEAN : extraversion faible (introversion).
 */
